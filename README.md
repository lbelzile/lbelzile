...
The repositories on Github contain code for the **R** packages that I (co-)authored including
...
or those which I did not author, but for which I am the current maintainer on the [CRAN](https://cran.r-project.org/)
...
8. Léo R. Belzile, Alain Desgagné, Christian Genest and Frédéric Ouimet (2025). *Normal approximations for the multivariate inverse Gaussian distribution and asymmetric kernel smoothing on d-dimensional half-spaces*. Electronic Journal of Statistics, 19, pp. 1–54. [`DOI:10.1214/25-EJS2407`](https://doi.org/10.1214/25-EJS2407). [Code](https://github.com/lbelzile/mig-kernel).
9. Léo R. Belzile (2025). *longevity: An R Package for Modelling Excess Lifetimes*. R Journal, 17(4), pp. 37–58. [`DOI:10.32614/RJ-2025-034`](https://doi.org/10.32614/RJ-2025-034). [Code](https://github.com/lbelzile/longevity-Rjournal).
...
4. Léo R. Belzile and Anthony C. Davison. *Choosing the threshold in extreme value analysis* (2026+). [Code](https://github.com/lbelzile/choosing-threshold)
